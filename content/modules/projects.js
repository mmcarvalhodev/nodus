...
const NodusProjects = {
  ...
  async setActiveProject(projectId) {
    ...
    console.log('[Projects] Projeto ativo:', projectId);
  },
  ...
  async createProject(name, color) {
    ...
    console.log('[Projects] Criado:', project.name);
    return project;
  },
  ...
  async updateProject(projectId, updates) {
    ...
    console.log('[Projects] Atualizado:', projects[idx].name);
    return projects[idx];
  },
  ...
  async deleteProject(projectId) {
    ...
    console.log('[Projects] Deletado:', projectId);
  },
  ...
  async moveIdeaToProject(ideaId, queueKey, projectId) {
    ...
    console.log('[Projects] Idea movida:', ideaId, '→', projectId);
    return true;
  },
  ...
  async moveChainToProject(chainId, projectId) {
    ...
    console.log('[Projects] Chain movida:', chainId, '→', projectId);
    return true;
  },
  ...
  /**
   * Verificar se pode criar projeto. Limite vem do server via getLimits()
   * (capabilities.limits.maxProjects). null = ilimitado.
   */
  async canCreateProject() {
    const limits = window.NodusLicense?.getLimits?.() || { maxProjects: 3 };
    if (limits.maxProjects === null || limits.maxProjects === undefined) {
  ...
  async migrateExistingData() {
    ...
    console.log('[Projects] Migrando dados existentes...');
    ...
    await chrome.storage.local.set(updates);
    console.log('[Projects] Migration concluida');
  }
};

// Export
window.NodusProjects = NodusProjects;
console.log('[Projects] Modulo carregado');
