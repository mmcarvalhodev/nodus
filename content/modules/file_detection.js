...
const NodusFileDetection = {
    ...
    detectGeneratedFile(responseElement) {
        ...
        try {
            ...
            if (hasDownloadAttr) {
                console.log('[FileDetection] Detectado via atributo [download]');
                return true;
            }
            ...
            for (const selector of downloadClasses) {
                if (responseElement.querySelector(selector)) {
                    console.log('[FileDetection] Detectado via classe:', selector);
                    return true;
                }
            }
            ...
            if (hasDownloadText) {
                console.log('[FileDetection] Detectado via texto "Download"');
                return true;
            }
            ...
            if (hasDownloadIcon) {
                console.log('[FileDetection] Detectado via ícone de download');
                return true;
            }
            ...
            if (hasBlobUrl) {
                console.log('[FileDetection] Detectado via blob:/data: URL');
                return true;
            }
