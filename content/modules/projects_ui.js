...
const NodusProjectsUI = {
   ...
   */
  async init() {
    console.log('[ProjectsUI] Inicializando...');
  ...
  _setupEventListeners() {
    ...
    view.addEventListener('dragstart', (e) => {
      ...
      console.log('[ProjectsUI] Drag start:', dragType, dragId);
    });
    ...
    view.addEventListener('drop', async (e) => {
      ...
      try {
        ...
        console.log('[ProjectsUI] Drop:', data.type, data.id, '→', targetProjectId);
...
console.log('[ProjectsUI] Modulo carregado');
