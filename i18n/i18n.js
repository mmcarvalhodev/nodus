...
const NodusI18n = {
  ...
  translations: {
    ...
    'queue.all': {
      ...
      ja: 'すべてのキュー',
      it: 'Tutte le Code', zh: '所有队列', ko: '모든 큐', hi: 'सभी कतारें'
    },
    'queue.showing': {
      pt: 'Mostrando',
      en: 'Showing',
    ...
    // ─────────────────────────────────────────────────────────────
    'queue.all': {
      pt: 'Todas as Filas', en: 'All Queues', es: 'Todas las Colas',
      fr: 'Toutes les Files', de: 'Alle Warteschlangen', ja: 'すべてのキュー',
      it: 'Tutte le Code', zh: '所有队列', ko: '모든 큐', hi: 'सभी कतारें'
    },
    'queue.quick': {
    ...
    // ═══════════════════════════════════════════════════════════════
    // i18n sweep migrado de v4.190.0 (37 chaves)
    // attach.*, dropchain.*, btn.*, engine.toast.*, placeholder.*,
    // popup.status.active, progress.loadingimage, projects.empty.*,
    // queue.all_short, settings.telemetry.off.*, sidebar.selectedcount,
    // toast.copypastechat
    // ═══════════════════════════════════════════════════════════════
    'attach.confirm.deleteattachment': { pt: 'Remover este arquivo?',                           en: 'Remove this file?',                                    es: '¿Eliminar este archivo?',                              fr: 'Supprimer ce fichier ?',                                     de: 'Diese Datei entfernen?',                                   ja: 'このファイルを削除しますか？',                            it: 'Rimuovere questo file?',                                     zh: '删除此文件？',                           ko: '이 파일을 제거하시겠습니까?',             hi: 'यह फ़ाइल हटाएं?' },
    'attach.empty.nofiles':            { pt: 'Nenhum arquivo anexado',                          en: 'No files attached',                                     es: 'Ningún archivo adjunto',                                fr: 'Aucun fichier joint',                                        de: 'Keine Dateien angehängt',                                   ja: '添付ファイルなし',                                       it: 'Nessun file allegato',                                        zh: '未附加文件',                              ko: '첨부 파일 없음',                          hi: 'कोई फ़ाइल संलग्न नहीं' },
    'attach.error.copyfailed':         { pt: 'Erro ao copiar',                                 en: 'Failed to copy',                                        es: 'Error al copiar',                                       fr: 'Échec de la copie',                                          de: 'Kopieren fehlgeschlagen',                                   ja: 'コピーに失敗しました',                                  it: 'Errore nella copia',                                          zh: '复制失败',                               ko: '복사 실패',                               hi: 'कॉपी विफल' },
    'attach.error.drophandlernotavailable': { pt: 'Drop handler não disponível',                en: 'Drop handler not available',                            es: 'Manejador de drop no disponible',                       fr: 'Gestionnaire de drop indisponible',                          de: 'Drop-Handler nicht verfügbar',                              ja: 'ドロップハンドラーが利用できません',                       it: 'Drop handler non disponibile',                                zh: '拖放处理器不可用',                        ko: '드롭 핸들러를 사용할 수 없음',           hi: 'ड्रॉप हैंडलर उपलब्ध नहीं' },
    'attach.error.ideanotfound':       { pt: 'Erro: Ideia não encontrada',                      en: 'Error: Idea not found',                                es: 'Error: Idea no encontrada',                            fr: 'Erreur : Idée introuvable',                                  de: 'Fehler: Idee nicht gefunden',                              ja: 'エラー: アイデアが見つかりません',                       it: 'Errore: Idea non trovata',                                   zh: '错误：未找到想法',                       ko: '오류: 아이디어를 찾을 수 없음',          hi: 'त्रुटि: विचार नहीं मिला' },
    'attach.error.injectfailed':       { pt: 'Erro ao injetar arquivos',                       en: 'Failed to inject files',                                es: 'Error al inyectar archivos',                            fr: 'Échec de l\'injection des fichiers',                          de: 'Dateien konnten nicht eingefügt werden',                    ja: 'ファイルの挿入に失敗しました',                            it: 'Errore nell\'iniettare file',                                  zh: '注入文件失败',                            ko: '파일 삽입 실패',                          hi: 'फ़ाइलें इंजेक्ट करने में विफल' },
    'attach.toast.infocopied':         { pt: '✅ Info copiada para clipboard!',                  en: '✅ Info copied to clipboard!',                            es: '✅ ¡Información copiada al portapapeles!',                fr: '✅ Infos copiées dans le presse-papiers !',                    de: '✅ Info in die Zwischenablage kopiert!',                     ja: '✅ クリップボードに情報をコピーしました！',                  it: '✅ Info copiate negli appunti!',                                zh: '✅ 信息已复制到剪贴板！',                  ko: '✅ 클립보드에 정보가 복사되었습니다!',     hi: '✅ जानकारी क्लिपबोर्ड पर कॉपी की गई!' },
    'attach.toast.selectatleastone':   { pt: 'Selecione pelo menos um arquivo!',                en: 'Select at least one file!',                              es: '¡Selecciona al menos un archivo!',                       fr: 'Sélectionnez au moins un fichier !',                          de: 'Wähle mindestens eine Datei aus!',                          ja: '少なくとも1つのファイルを選択してください！',              it: 'Seleziona almeno un file!',                                    zh: '请至少选择一个文件！',                    ko: '파일을 하나 이상 선택하세요!',             hi: 'कम से कम एक फ़ाइल चुनें!' },
    'btn.add': {
      pt: 'Adicionar', en: 'Add', es: 'Añadir',
      fr: 'Ajouter', de: 'Hinzufügen', ja: '追加',
      it: 'Aggiungi', zh: '添加', ko: '추가', hi: 'जोड़ें'
    },
    'btn.clear': {
      ...
      it: 'Pulisci', zh: '清除', ko: '지우기', hi: 'साफ़ करें'
    },
    'btn.close': {
      pt: 'Fechar', en: 'Close', es: 'Cerrar',
      fr: 'Fermer', de: 'Schließen', ja: '閉じる',
      it: 'Chiudi', zh: '关闭', ko: '닫기', hi: 'बंद करें'
    },
    'btn.savenotes':                   { pt: 'Salvar Notes', en: 'Save Notes', es: 'Guardar Notas', fr: 'Enregistrer les Notes', de: 'Notizen speichern', ja: 'メモを保存', it: 'Salva note', zh: '保存笔记', ko: '메모 저장', hi: 'नोट्स सहेजें' },
    'dropchain.error.chainempty':      { pt: '❌ Conteúdo da cadeia vazio',                    en: '❌ Chain content is empty',                              es: '❌ Contenido de la cadena vacío',                       fr: '❌ Contenu de la chaîne vide',                                de: '❌ Ketteninhalt ist leer',                                   ja: '❌ チェーンの内容が空です',                              it: '❌ Contenuto della catena vuoto',                              zh: '❌ 链内容为空',                          ko: '❌ 체인 내용이 비어 있음',                hi: '❌ श्रृंखला सामग्री खाली है' },
    'dropchain.error.copyfailed':      { pt: '❌ Erro ao copiar',                              en: '❌ Failed to copy',                                      es: '❌ Error al copiar',                                    fr: '❌ Échec de la copie',                                        de: '❌ Kopieren fehlgeschlagen',                                  ja: '❌ コピーに失敗しました',                                  it: '❌ Errore nella copia',                                        zh: '❌ 复制失败',                            ko: '❌ 복사 실패',                            hi: '❌ कॉपी विफल' },
    'dropchain.error.infoinjectfailed':{ pt: '❌ Erro ao injetar info',                         en: '❌ Failed to inject info',                               es: '❌ Error al inyectar info',                             fr: '❌ Échec de l\'injection des infos',                          de: '❌ Info konnte nicht eingefügt werden',                      ja: '❌ 情報の挿入に失敗しました',                              it: '❌ Errore nell\'iniettare info',                                zh: '❌ 注入信息失败',                        ko: '❌ 정보 삽입 실패',                       hi: '❌ जानकारी इंजेक्ट करने में विफल' },
    'dropchain.error.injectfailed':    { pt: '❌ Erro ao injetar cadeia',                       en: '❌ Failed to inject chain',                              es: '❌ Error al inyectar cadena',                           fr: '❌ Échec de l\'injection de la chaîne',                       de: '❌ Kette konnte nicht eingefügt werden',                     ja: '❌ チェーンの挿入に失敗しました',                          it: '❌ Errore nell\'iniettare la catena',                          zh: '❌ 注入链失败',                          ko: '❌ 체인 삽입 실패',                       hi: '❌ श्रृंखला इंजेक्ट करने में विफल' },
    'dropchain.error.injectfilesfailed': { pt: '❌ Erro ao injetar arquivos',                   en: '❌ Failed to inject files',                              es: '❌ Error al inyectar archivos',                         fr: '❌ Échec de l\'injection des fichiers',                       de: '❌ Dateien konnten nicht eingefügt werden',                  ja: '❌ ファイルの挿入に失敗しました',                          it: '❌ Errore nell\'iniettare file',                                zh: '❌ 注入文件失败',                        ko: '❌ 파일 삽입 실패',                       hi: '❌ फ़ाइलें इंजेक्ट करने में विफल' },
    'dropchain.error.textareanotfound':{ pt: '❌ Área de texto não encontrada',                en: '❌ Text area not found',                                  es: '❌ Área de texto no encontrada',                        fr: '❌ Zone de texte introuvable',                                de: '❌ Textbereich nicht gefunden',                              ja: '❌ テキストエリアが見つかりません',                       it: '❌ Area di testo non trovata',                                  zh: '❌ 未找到文本区域',                      ko: '❌ 텍스트 영역을 찾을 수 없음',           hi: '❌ टेक्स्ट एरिया नहीं मिला' },
    'dropchain.success.attached':      { pt: '✅ Cadeia anexada como arquivo!',                  en: '✅ Chain attached as file!',                              es: '✅ ¡Cadena adjuntada como archivo!',                       fr: '✅ Chaîne attachée comme fichier !',                            de: '✅ Kette als Datei angehängt!',                                 ja: '✅ チェーンをファイルとして添付しました！',                  it: '✅ Catena allegata come file!',                                  zh: '✅ 链已作为文件附加！',                  ko: '✅ 체인이 파일로 첨부되었습니다!',           hi: '✅ श्रृंखला फ़ाइल के रूप में संलग्न की गई!' },
    'dropchain.warn.attachasfailed':   { pt: '⚠️ Não foi possível anexar como arquivo — colado como texto', en: '⚠️ Could not attach as file — pasted as text',     es: '⚠️ No se pudo adjuntar como archivo — pegado como texto', fr: '⚠️ Impossible d\'attacher comme fichier — collé en texte', de: '⚠️ Konnte nicht als Datei anhängen — als Text eingefügt', ja: '⚠️ ファイルとして添付できません — テキストとして貼り付け', it: '⚠️ Impossibile allegare come file — incollato come testo', zh: '⚠️ 无法作为文件附加 — 已作为文本粘贴', ko: '⚠️ 파일로 첨부할 수 없음 — 텍스트로 붙여넣음', hi: '⚠️ फ़ाइल के रूप में संलग्न नहीं किया जा सका — पाठ के रूप में पेस्ट किया गया' },
    'dropchain.warn.inputnotfound':    { pt: '⚠️ Input de arquivo não encontrado — conteúdo colado como texto', en: '⚠️ File input not found — content pasted as text', es: '⚠️ Input de archivo no encontrado — contenido pegado como texto', fr: '⚠️ Champ de fichier introuvable — contenu collé en texte', de: '⚠️ Dateieingabe nicht gefunden — Inhalt als Text eingefügt', ja: '⚠️ ファイル入力が見つかりません — テキストとして貼り付け', it: '⚠️ Input file non trovato — contenuto incollato come testo', zh: '⚠️ 未找到文件输入 — 内容已作为文本粘贴', ko: '⚠️ 파일 입력을 찾을 수 없음 — 텍스트로 붙여넣음', hi: '⚠️ फ़ाइल इनपुट नहीं मिला — सामग्री पाठ के रूप में पेस्ट की गई' },
    'engine.toast.alreadysaved':       { pt: 'ℹ️ Já salvo',                                    en: 'ℹ️ Already saved',                                       es: 'ℹ️ Ya guardado',                                         fr: 'ℹ️ Déjà enregistré',                                          de: 'ℹ️ Bereits gespeichert',                                     ja: 'ℹ️ 既に保存済み',                                          it: 'ℹ️ Già salvato',                                              zh: 'ℹ️ 已保存',                              ko: 'ℹ️ 이미 저장됨',                          hi: 'ℹ️ पहले से सहेजा गया' },
    'engine.toast.noideasaved':        { pt: 'ℹ️ Nenhuma ideia salva',                          en: 'ℹ️ No ideas saved',                                      es: 'ℹ️ Ninguna idea guardada',                               fr: 'ℹ️ Aucune idée enregistrée',                                  de: 'ℹ️ Keine Ideen gespeichert',                                 ja: 'ℹ️ 保存されたアイデアはありません',                       it: 'ℹ️ Nessuna idea salvata',                                       zh: 'ℹ️ 没有保存的想法',                       ko: 'ℹ️ 저장된 아이디어 없음',                  hi: 'ℹ️ कोई विचार सहेजा नहीं' },
    'engine.toast.pasted':             { pt: '📋 Colado!',                                      en: '📋 Pasted!',                                             es: '📋 ¡Pegado!',                                            fr: '📋 Collé !',                                                  de: '📋 Eingefügt!',                                              ja: '📋 貼り付けました！',                                      it: '📋 Incollato!',                                                zh: '📋 已粘贴！',                            ko: '📋 붙여넣음!',                            hi: '📋 पेस्ट किया गया!' },
    'engine.toast.pasteerror':         { pt: '❌ Erro ao colar',                                en: '❌ Failed to paste',                                     es: '❌ Error al pegar',                                      fr: '❌ Échec du collage',                                          de: '❌ Einfügen fehlgeschlagen',                                  ja: '❌ 貼り付けに失敗しました',                                it: '❌ Errore nell\'incollare',                                    zh: '❌ 粘贴失败',                            ko: '❌ 붙여넣기 실패',                        hi: '❌ पेस्ट विफल' },
    'placeholder.chainname': {
      pt: 'Nome da chain...', en: 'Chain name...', es: 'Nombre de la cadena...',
      fr: 'Nom de la chaîne...', de: 'Kettenname...', ja: 'チェーン名...',
      it: 'Nome della catena...', zh: '链名称...', ko: '체인 이름...', hi: 'श्रृंखला नाम...'
    },
    'placeholder.chainnotes': {
      pt: 'Escreva suas notas sobre esta chain...',
      en: 'Write your notes about this chain...',
      es: 'Escribe tus notas sobre esta cadena...',
      fr: 'Écrivez vos notes sur cette chaîne...',
      de: 'Schreibe deine Notizen zu dieser Kette...',
      ja: 'このチェーンに関するメモを書く...',
      it: 'Scrivi le tue note su questa catena...',
      zh: '写下关于此链的笔记...',
      ko: '이 체인에 대한 메모 작성...',
      hi: 'इस श्रृंखला पर अपने नोट्स लिखें...'
    },
    'placeholder.searchideas': {
      pt: '🔍 Buscar ideias...', en: '🔍 Search ideas...', es: '🔍 Buscar ideas...',
      fr: '🔍 Rechercher des idées...', de: '🔍 Ideen suchen...', ja: '🔍 アイデアを検索...',
      it: '🔍 Cerca idee...', zh: '🔍 搜索想法...', ko: '🔍 아이디어 검색...', hi: '🔍 विचार खोजें...'
    },
    'popup.status.active':             { pt: 'Ativo', en: 'Active', es: 'Activo', fr: 'Actif', de: 'Aktiv', ja: '有効', it: 'Attivo', zh: '已启用', ko: '활성', hi: 'सक्रिय' },
    'progress.loadingimage': {
      pt: 'Carregando imagem {current}/{total}...',
      en: 'Loading image {current}/{total}...',
      es: 'Cargando imagen {current}/{total}...',
      fr: 'Chargement de l\'image {current}/{total}...',
      de: 'Bild {current}/{total} wird geladen...',
      ja: '画像 {current}/{total} を読み込み中...',
      it: 'Caricamento immagine {current}/{total}...',
      zh: '正在加载图片 {current}/{total}...',
      ko: '이미지 {current}/{total} 로드 중...',
      hi: 'छवि {current}/{total} लोड हो रही है...'
    },
    'projects.empty': {
      pt: 'Nenhum item neste projeto',
      en: 'No items in this project',
      es: 'Ningún elemento en este proyecto',
      fr: 'Aucun élément dans ce projet',
      de: 'Keine Elemente in diesem Projekt',
      ja: 'このプロジェクトにアイテムがありません',
      it: 'Nessun elemento in questo progetto',
      zh: '此项目中没有项目',
      ko: '이 프로젝트에 항목 없음',
      hi: 'इस परियोजना में कोई आइटम नहीं'
    },
    'projects.empty.subtitle': {
      pt: 'Salve cards ou cadeias para organizá-los aqui',
      en: 'Save cards or chains to organize them here',
      es: 'Guarda tarjetas o cadenas para organizarlas aquí',
      fr: 'Enregistrez des cartes ou des chaînes pour les organiser ici',
      de: 'Speichere Karten oder Ketten, um sie hier zu organisieren',
      ja: 'カードまたはチェーンを保存してここで整理',
      it: 'Salva schede o catene per organizzarle qui',
      zh: '保存卡片或链以在此组织',
      ko: '카드나 체인을 저장하여 여기에 정리하세요',
      hi: 'कार्ड या श्रृंखलाएँ सहेजें ताकि उन्हें यहाँ व्यवस्थित किया जा सके'
    },
    'queue.all_short': {
      pt: 'Todas', en: 'All', es: 'Todas',
      fr: 'Toutes', de: 'Alle', ja: 'すべて',
      it: 'Tutte', zh: '全部', ko: '전체', hi: 'सभी'
    },
    'settings.telemetry.off.hint': {
      pt: 'Ative para ver estatísticas e logs',
      en: 'Enable to see statistics and logs',
      es: 'Actívala para ver estadísticas y registros',
      fr: 'Activez pour voir les statistiques et journaux',
      de: 'Aktivieren, um Statistiken und Protokolle zu sehen',
      ja: '統計とログを表示するには有効にしてください',
      it: 'Attiva per vedere statistiche e log', zh: '启用以查看统计和日志', ko: '통계 및 로그를 보려면 활성화하세요', hi: 'आँकड़े और लॉग देखने के लिए सक्षम करें'
    },
    'settings.telemetry.off.title': {
      pt: 'Telemetria desativada',
      en: 'Telemetry disabled',
      es: 'Telemetría desactivada',
      fr: 'Télémétrie désactivée',
      de: 'Telemetrie deaktiviert',
      ja: 'テレメトリ無効',
      it: 'Telemetria disabilitata', zh: '遥测已禁用', ko: '텔레메트리 비활성화', hi: 'टेलीमेट्री अक्षम'
    },
    'sidebar.selectedcount': {
      pt: '{count} selecionado(s)', en: '{count} selected', es: '{count} seleccionado(s)',
      fr: '{count} sélectionné(s)', de: '{count} ausgewählt', ja: '{count} 件選択',
      it: '{count} selezionato/i', zh: '已选 {count} 项', ko: '{count}개 선택됨', hi: '{count} चयनित'
    },
    'toast.copypastechat': {
      pt: '✅ Copiado! Cole no chat (Ctrl+V)',
      en: '✅ Copied! Paste in chat (Ctrl+V)',
      es: '✅ ¡Copiado! Pega en el chat (Ctrl+V)',
      fr: '✅ Copié ! Collez dans le chat (Ctrl+V)',
      de: '✅ Kopiert! In den Chat einfügen (Strg+V)',
      ja: '✅ コピーしました！チャットに貼り付け（Ctrl+V）',
      it: '✅ Copiato! Incolla nella chat (Ctrl+V)',
      zh: '✅ 已复制！在聊天中粘贴 (Ctrl+V)',
      ko: '✅ 복사됨! 채팅에 붙여넣기 (Ctrl+V)',
      hi: '✅ कॉपी किया गया! चैट में पेस्ट करें (Ctrl+V)'
    }
  },
  ...
  async setLanguage(lang) {
    ...
    console.log('[i18n] Idioma alterado para:', this.currentLang);
  },
